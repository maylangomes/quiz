...
const Quiz = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-xl mx-auto mt-8 bg-gray-800 text-gray-200 p-6 rounded-lg">
      <div className="mt-8">
        <h2 className="text-lg font-semibold">Prénom</h2>
        <Input type="text" {...register('prenom', { required: "prenom empty" })} className="mt-1 w-full bg-gray-200 text-gray-800 px-3 py-2 rounded-lg" />
      </div>
      <div className="mt-8">
      ...
      <div className="mt-8">
        ...
        <div className="mt-3">
          <div className="flex items-center space-x-2">
            <input type="radio" id="3m" value="3m" {...register("hauteurPanier")} className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
            <label htmlFor="3m" className="ml-2 text-lg">3 mètres</label>
          </div>
          <div className="flex items-center space-x-2">
            <input type="radio" id="3m05" value="3m05" {...register("hauteurPanier")} className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
            <label htmlFor="3m05" className="ml-2 text-lg">3,05 mètres</label>
          </div>
          <div className="flex items-center space-x-2">
            <input type="radio" id="3m10" value="3m10" {...register("hauteurPanier")} className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
